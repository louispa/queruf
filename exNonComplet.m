% sequential_monte_carlo_simple_02PA_incomplete.m - Online Thu 30 Apr 2015
...
out_noise_pdf = @(w) 1/sqrt((2*pi)^d_x*abs(det(Sigma_w))) * exp(-.5*(w-mu_w)'*inv(Sigma_w)*(w-mu_w));  % pdf of the output noise w_t
